...
class Display:
    ...
    #@param curr_select numer obecnie wybranego przycisku
    ...
    #@param purchased slownik zakupionych ulepszen
    #@param enough informacja, czy gracz posiada wystarczajace srodki do zakupu
